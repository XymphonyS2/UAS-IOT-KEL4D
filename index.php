...
<body class="min-h-screen login-gradient flex items-center justify-center p-4">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">CHICKMON</h1>
            <p class="text-white/70">Smart Monitoring & Control System</p>
        </div>
        ...
        <div class="glass-card rounded-3xl shadow-2xl p-8">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100">
                <p class="text-center text-sm text-gray-500">
                    Default: <span class="font-medium text-gray-700">admin</span> / <span class="font-medium text-gray-700">admin123</span>
                </p>
            </div>
        </div>

        <p class="text-center text-white/60 text-sm mt-6">
            © 2024 CHICKMON - Smart Monitoring System
        </p>
    </div>
</body>
</html>
